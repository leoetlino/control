...
n(h,e);break}b||void 0===(h=n(h))||(a[k]=h)}return a};f.defaults={};c.removeCookie=function(b,e){if(void 0===c.cookie(b))return!1;c.cookie(b,"",c.extend({},e,{expires:-1}));return!c.cookie(b)}});$(function(){"true"===$.cookie("cookies-law-accepted")?$.cookie("cookies-law-accepted",!0,{expires:365,path:"/"}):($("#cookie-modal").modal(),$("#cookie-modal").on("hide.bs.modal",function(){$.cookie("cookies-law-accepted",!0,{expires:365,path:"/"})}))});